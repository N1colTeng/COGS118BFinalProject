...
testpts=[mfeat_kar(1:50,:);mfeat_kar(201:250,:)];
goto=size(testpts,1);
...
testpts=[mfeat_kar(1:50,:);mfeat_kar(201:250,:);
         mfeat_kar(401:450,:);mfeat_kar(601:650,:)
         mfeat_kar(801:850,:);mfeat_kar(1001:1050,:)
         mfeat_kar(1201:1250,:);mfeat_kar(1401:1450,:)
         mfeat_kar(1601:1650,:);mfeat_kar(1801:1850,:)];
goto=size(testpts,1);
