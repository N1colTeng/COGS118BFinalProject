...
testpts=[mfeat_mor(1:50,:);mfeat_mor(201:250,:)];
goto=size(testpts,1);
...
testpts=[mfeat_mor(1:50,:);mfeat_mor(201:250,:);
         mfeat_mor(401:450,:);mfeat_mor(601:650,:)
         mfeat_mor(801:850,:);mfeat_mor(1001:1050,:)
         mfeat_mor(1201:1250,:);mfeat_mor(1401:1450,:)
         mfeat_mor(1601:1650,:);mfeat_mor(1801:1850,:)];
goto=size(testpts,1);
