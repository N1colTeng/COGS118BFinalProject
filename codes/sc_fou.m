...
testpts=[mfeat_fou(1:50,:);mfeat_fou(201:250,:)];
goto=size(testpts,1);
...
testpts=[mfeat_fou(1:50,:);mfeat_fou(201:250,:);
         mfeat_fou(401:450,:);mfeat_fou(601:650,:)
         mfeat_fou(801:850,:);mfeat_fou(1001:1050,:)
         mfeat_fou(1201:1250,:);mfeat_fou(1401:1450,:)
         mfeat_fou(1601:1650,:);mfeat_fou(1801:1850,:)];
goto=size(testpts,1);
