...
testpts=[mfeat_fac(1:50,:);mfeat_fac(201:250,:)];
goto=size(testpts,1);
...
testpts=[mfeat_fac(1:50,:);mfeat_fac(201:250,:);
         mfeat_fac(401:450,:);mfeat_fac(601:650,:)
         mfeat_fac(801:850,:);mfeat_fac(1001:1050,:)
         mfeat_fac(1201:1250,:);mfeat_fac(1401:1450,:)
         mfeat_fac(1601:1650,:);mfeat_fac(1801:1850,:)];
goto=size(testpts,1);
